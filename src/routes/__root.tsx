...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Self-hosted Voice AI platform. Run real phone-line agents on your own infrastructure with Gemini Live, AI Copilot, live supervisor monitor and compliance engine." },
      { name: "author", content: "Lunara" },
      { property: "og:title", content: "Lunara — On-Premise Voice AI for Enterprise" },
      { property: "og:description", content: "Voice AI on your servers, your numbers, your data. The self-hosted alternative to Vapi, Retell and Bland." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Lunara — On-Premise Voice AI for Enterprise" },
      { name: "twitter:description", content: "Voice AI on your servers, your numbers, your data." },
